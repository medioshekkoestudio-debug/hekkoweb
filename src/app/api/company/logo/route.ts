...
// POST /api/company/logo — sube o reemplaza el logo de Hekko. Solo admin.
// La imagen se comprime en el cliente, así que subirla por el servidor en
// multipart es suficiente.
